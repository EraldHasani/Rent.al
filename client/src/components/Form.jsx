...
<div>
  <h1 style={{ marginTop: "30px", marginBottom: "30px" }} >Equipment</h1>
                ...
                <div className="d-flex justify-content-flex-start border-bottom">
                   <p style={{ textAlign: "left", marginTop: "10px", marginBottom: "10px" }}>Comfort (optional)</p>
  ...
  <div>
    ...
    <label htmlFor="antiSpin">Air suspension</label>
                  ...
                  <div className="d-flex justify-content-flex-start border-bottom">
                     <p style={{ textAlign: "left", marginTop: "10px", marginBottom: "10px" }}>Exterior (optional)</p>
                    <div style={{ textAlign: "left", marginTop: "10px", marginBottom: "10px" }} >
...
<div className="checkbox-lineup">
  <div >
    <input className="m-2" type="checkbox" id="electricalMirrors" value="electricalMirrors" name="electricalMirrors" checked={exterior["electricalMirrors"]} onChange={handleCheckboxChange1} />
  ...
  <div>
    ...
    <label htmlFor="darkWindowsBehind">Tinted Windows</label>
                ...
                <div className="d-flex justify-content-flex-start border-bottom">
                   <p style={{ textAlign: "left", marginTop: "10px", marginBottom: "10px" }}>Media & Entertainment (optional)</p>
                  <div style={{ textAlign: "left", marginTop: "10px", marginBottom: "10px" }}>
  ...
  <div>
    ...
    <label className="small" htmlFor="tvScreenInTheBackSeat">TV screen in the back seat</label>
                 ...
                 <div className="d-flex justify-content-flex-start border-bottom">
                  <p style={{ textAlign: "left", marginTop: "10px", marginBottom: "10px" }}>Security (optional)</p>
